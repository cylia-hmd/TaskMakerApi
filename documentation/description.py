api_description = """
# Description de l'Application de Gestion des Tâches pour Étudiants

L'application de gestion des tâches pour étudiants est conçue pour aider les étudiants à gérer leurs devoirs, rappels et calendrier académique. Elle offre les fonctionnalités suivantes :
